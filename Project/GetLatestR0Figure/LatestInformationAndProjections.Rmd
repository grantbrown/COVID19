...
library(knitr)
out.ToPrint <- data.frame(Date = out$date, `Observed Cumulative Mortality` = out$Observed, `Median Fitted/Predicted Mortality` = out$q5, 
                          `Fitted/Predicted LB` = out$q1, `Fitted/Predicted UB` = out$q9) %>% filter(Date <= as.Date("2020-06-01"))

kable(out.ToPrint, digits = 1)
